...
{
    public static description = messages.getMessage('fix.priceRule.description');
    ...
    {
        return DataMoverService.repairPriceRules(this.flags.sourceorg, this.flags.targetorg);
    }
}
