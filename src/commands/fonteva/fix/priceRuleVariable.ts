...
export default class FixPriceRuleVariable extends SfdxCommand
{
    public static description = messages.getMessage('fix.priceRuleVariable.description');
    ...
    {
        return DataMoverService.repairPriceRuleVariables(this.flags.sourceorg, this.flags.targetorg);
    }
}
