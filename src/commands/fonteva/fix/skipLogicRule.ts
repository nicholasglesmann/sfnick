...
export default class FixSkipLogicRule extends SfdxCommand
{
    public static description = messages.getMessage('fix.skipLogicRule.description');
    ...
    {
        return DataMoverService.repairSkipLogicRules(this.flags.sourceorg, this.flags.targetorg);
    }
}
