...
export default class RetrieveProdWorkflows extends SfdxCommand
{
    public static description = messages.getMessage('retrieve.workflows.subcommands.prod.description');
