...
export default class RetrieveProdReports extends SfdxCommand
{
    public static description = messages.getMessage('retrieve.reports.subcommands.prod.description');
