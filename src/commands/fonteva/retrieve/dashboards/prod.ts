...
export default class RetrieveProdDashboards extends SfdxCommand
{
    public static description = messages.getMessage('retrieve.dashboards.subcommands.prod.description');
