...
export default class RetrieveProdEmailTemplates extends SfdxCommand
{
    public static description = messages.getMessage('retrieve.emailTemplates.subcommands.prod.description');
